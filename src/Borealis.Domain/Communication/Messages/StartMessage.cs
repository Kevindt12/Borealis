...
public class StartMessage : MessageBase
{
    ...
    public static StartMessage FromBuffer(ReadOnlyMemory<byte> buffer)
    {
        try
        {
            return JsonSerializer.Deserialize<StartMessage>(buffer.Span)!;
        }
    ...
    public StartMessage(int frameDelay, int ledstripIndex)
    {
