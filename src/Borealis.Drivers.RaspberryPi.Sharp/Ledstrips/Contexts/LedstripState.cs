...
public class LedstripState : IDisposable, IAsyncDisposable
{
    ...
    /// </summary>
    public LedstripState(AnimationPlayerFactory animationPlayerFactory, LedstripProxyBase ledstripProxy)
    {
    ...
    public virtual async Task StartAnimationAsync(Frequency frequency, ReadOnlyMemory<PixelColor>[] initialFrameBuffer, CancellationToken token = default)
    {
        ...
        try
        {
            ...
            AnimationPlayer player = _animationPlayerFactory.CreateAnimationPlayer(_ledstripProxy);
