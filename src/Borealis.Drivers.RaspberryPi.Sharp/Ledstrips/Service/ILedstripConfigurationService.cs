...
public interface ILedstripConfigurationService : ILedstripService
{
    ...
    /// <summary>
    /// Checks if you can change the configuration of the ledstrips.
    /// </summary>
    /// <returns> A <see cref="bool" /> indicating that we can change the configuration. </returns>
    bool CanLoadConfiguration();
}